...
//class AdditionViewCell: UICollectionViewCell {

class AdditionViewCell: UICollectionViewCell {
    @IBOutlet weak var cellNumber: UILabel!
}

class AdditionViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, GADBannerViewDelegate {
    ...
    @IBOutlet weak var additionCollection: UICollectionView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        additionCollection.delegate = self
        additionCollection.dataSource = self
       ...
       timer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(AdditionViewController.timerTick), userInfo: nil, repeats: true)
        ...
        self.bannerView.adUnitID = "ca-app-pub-7930281625187952/5220136977"
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! AdditionViewCell
        
        
        // Configure the cell
        let number = arrayOfNumbers[indexPath.row]
        print(number)
        cell.cellNumber.text = String(number)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let cell = collectionView.cellForItem(at: indexPath)as! AdditionViewCell
        print ("assigned cell")
        ...
        if selNum == 1 {
            ...
            val1 = Int(cell.cellNumber.text!)!
            selNum = selNum + 1
            cell.backgroundColor = UIColor(red: (255/255.0), green: (179/255.0), blue: (71/255.0), alpha: 1)
            currentPlayAttempt.Number1 = val1
            print("Current Play Attempt Number 1 \(val1)")
        }
            //second selection get value
        else if selNum == 2 {
            print ("entering selection 2")
            val2 = Int(cell.cellNumber.text!)!
            selNum = selNum + 1
            cell.backgroundColor = UIColor(red: (255/255.0), green: (179/255.0), blue: (71/255.0), alpha: 1)
            currentPlayAttempt.Number2 = val2
            print("Current Play Attempt Number 2 \(val2)")
        }
        ...
        //and set color to green otherwise change to red
            ...
            if hasSelectionBeenPlayed == false {
                ...
                if total == val1 + val2 {
                    ...
                    AdditionViewController.vibrate()
    ...
    @IBAction func newBoard(_ sender: Any) {
        ...
        self.additionCollection.reloadData()
        self.additionCollection.reloadItems(at: additionCollection.indexPathsForVisibleItems)
